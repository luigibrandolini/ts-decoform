...
const metastore_1 = require("../src/metastore");
const book_sample_1 = require("./book.sample");
describe("form metadata", () => {
    it("should give the fields count", () => {
        const meta = (0, metastore_1.getMeta)(book_sample_1.Book);
        expect(meta?.fields.length).toBe(2);
    });
});
describe("form rendering", () => {
    it("should generate a form with the correct fields", () => {
        const html = (0, index_1.renderForm)(book_sample_1.Book);
...
describe("renderFormPage", () => {
    it("should generate a full HTML page with Bootstrap 5", () => {
        const html = (0, index_1.renderFormPage)(book_sample_1.Book);
        // Basic checks
...
//# sourceMappingURL=decoform.test.js.map